						...
						<tr>
							...
							<td class="text-center">
                                <?php
                                    switch($row['status']){
                                        case '1':
                                            echo "<span class='badge badge-success bg-white badge-pill'>Active</span>";
                                            break;
                                        case '0':
...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Service Details","services/manage_service.php")
		})
        $('.edit_data').click(function(){
			uni_modal("Service Details","services/manage_service.php?id="+$(this).attr('data-id'))
		})
