...
-- Database: `msms_db`
--
CREATE DATABASE IF NOT EXISTS `msms_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `msms_db`;
...
(1, 'name', 'Mancraft Barbershop Booking System'),
(6, 'short_name', 'Mancraft Barbershop'),
(11, 'logo', 'uploads/mankraft.png'),
(13, 'user_avatar', 'uploads/user_avatar.jpg'),
(14, 'cover', 'uploads/cover-1638326239.png'),
(15, 'content', 'Array'),
(16, 'email', 'mankraft_barbers@gmail.com'),
(17, 'contact', '09123456789 / 456-4568-7899'),
(18, 'from_time', '09:00'),
(19, 'to_time', '19:00'),
(20, 'address', 'No 37, Jalan Sentral 2, Taman  Nusa Sentral, 81550 Iskandar Puteri, Johor');
...
(1, 'Adminstrator', NULL, 'Admin', 'admin', 'admin', 'uploads/avatar-1.png?v=1635556826', NULL, 1, 1, '2021-01-20 14:02:37', '2024-06-11 11:00:13'),
(3, 'John', NULL, 'Smith', 'jsmith', '1234\r\n', 'uploads/avatar-3.png?v=1638343842', NULL, 2, 1, '2021-12-01 15:30:41', '2024-06-11 11:00:27');
...
('root', '[{\"db\":\"msms_db\",\"table\":\"system_info\"},{\"db\":\"msms_db\",\"table\":\"users\"}]');
...
('root', '2024-06-11 03:07:33', '{\"Console\\/Mode\":\"collapse\"}');
